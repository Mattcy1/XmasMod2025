...
internal class CoalBoss : ModBoss
{
    ...
    public override void ModifyBaseBloonModel(BloonModel bloonModel)
    {
        ...
        var shield = Game.instance.model.GetBloon("Vortex1").GetBehavior<ReflectProjectilesInRadiusActionModel>()
            .Duplicate();
...
internal class CoalTotem : ModBloon
{
    ...
    public override void ModifyBaseBloonModel(BloonModel bloonModel)
    {
        ...
        var timeTrigger = new TimeTriggerModel("CoalTotemTimer", 15, false, new[] { "SpawnsBloonCoal" });
...
{
    public static Dictionary<Bloon, float> totems = new();
...
public class BloonSpawn
{
    ...
    public static void Postfix(Bloon __instance)
    {
        ...
        {
            var value = (float)(0.1 + rnd.NextDouble() * (0.9 - 0.1));

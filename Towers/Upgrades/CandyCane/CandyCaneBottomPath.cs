...
internal class BottomPath
{
    ...
    public class EvenStrongerThrow : ChristmasUpgrade<CandyCaneMonkey>
    {
        ...
        public override void ApplyUpgrade(TowerModel towerModel)
        {
            ...
            towerModel.GetWeapon().projectile.GetBehavior<CreateProjectileOnExhaustPierceModel>().projectile
                .GetDamageModel().damage += 1;
        }
    }
...
public class CandyCaneMonkey005 : ModDisplay
{
    ...
    public override void ModifyDisplayNode(UnityDisplayNode node)
    {
        SetMeshTexture(node, Name);
        SetMeshTexture(node, Name, 1);
        SetMeshOutlineColor(node, Color.green);
        SetMeshOutlineColor(node, Color.green, 1);
    }
}
...
public class DropGifts
{
    ...
    public static void Postfix(Weapon __instance)
    {
        ...
        {
            var shouldDrop = new Random().Next(1, 3);

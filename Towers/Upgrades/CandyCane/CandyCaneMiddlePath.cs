...
internal class MiddlePath
{
    public class ImprovedEyesight : ChristmasUpgrade<CandyCaneMonkey>
    {
        ...
        {
            foreach (var attackModel in towerModel.GetAttackModels()) attackModel.range += 10;
            towerModel.range += 10;
    ...
    public class EvenBetterEyesight : ChristmasUpgrade<CandyCaneMonkey>
    {
        ...
        public override void ApplyUpgrade(TowerModel towerModel)
        {
            foreach (var attackModel in towerModel.GetAttackModels()) attackModel.range += 5;
    ...
    public class FireyCandyCane : ChristmasUpgrade<CandyCaneMonkey>
    {
        ...
        public override void ApplyUpgrade(TowerModel towerModel)
        {
            ...
            towerModel.GetWeapon().projectile.collisionPasses = new[] { -1, 0 };
            var LavaBehavior = Game.instance.model.GetTowerFromId("Alchemist").GetDescendant<AddBehaviorToBloonModel>()
                .Duplicate();
...
public class CandyCaneRing : ChristmasUpgrade<CandyCaneMonkey>
{
    ...
    public override void ApplyUpgrade(TowerModel towerModel)
    {
        ...
        var attack = Game.instance.model.GetTowerFromId(TowerID<CandyCaneMonkey>(0, 3)).GetAttackModel().Duplicate();
...
public class CandyCaneMonkey040 : ModDisplay
{
    ...
    public override void ModifyDisplayNode(UnityDisplayNode node)
    {
        ...
        SetMeshOutlineColor(node, Color.white);
        SetMeshOutlineColor(node, Color.white, 1);
        SetMeshOutlineColor(node, Color.white, 2);
    }
}

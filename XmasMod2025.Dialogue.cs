...
public partial class XmasMod2025
{
    ...
    public static void AddDialogue()
    {
        ...
        DialogUi.instance.AddToDialogQueue(
            ...
            Santa("Happy", "Elves can make gifts and attack for you! There very helpful little dudes.", 3),
            Santa("Happy", "Some elf went rogue a while back though so you might want to get some attack elves. Because he might come to fight us and he can't take damage from normal monkeys.", 3),
            ...
            ElfElder("Neutral",
                ...
                25),
            Player("Neutral", "I remember Santa telling me that before he got captured!", 25),
            ElfElder("Neutral",
